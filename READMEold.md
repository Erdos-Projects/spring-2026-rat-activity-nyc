...
├── scr/
│   ├── data/
│   │   ├── download_recent_data.ipynb
│   │   ├── data_parquet/          ← main data files (Git LFS)
│   │   │   ├── rat_sightings.parquet
│   │   │   ├── rodent_inspection.parquet
│   │   │   └── irs.parquet
│   │   ├── rat_sightings_data/
│   │   └── cleaned_rat_inspection_data/
│   └── cleaning/                  ← run these notebooks first
│
├── results/                       ← model outputs and forecasts
